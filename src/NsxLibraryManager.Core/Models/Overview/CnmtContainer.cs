...
namespace NsxLibraryManager.Core.Models.Overview;
...
public class CnmtContainer 
{
    ...
    /// <summary>
    /// True when <see cref="SectionItem"/> of type <see cref="Code"/> is sparse, which means <see cref="MainItem"/> is normally null
    /// </summary>
